 ...
 * @author jeferson
 */
public class ConsultaProcedimentosTableModel extends AbstractTableModel{
...
//constantes que vão representar as colunas
    ...
    private List<ConsultaProcedimento> procedimentos;
     ...
     public ConsultaProcedimentosTableModel() {
        procedimentos = new ArrayList();
    }
     
      public ConsultaProcedimentosTableModel(List<ConsultaProcedimento> lista) {
        this();
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ConsultaProcedimento p = procedimentos.get(rowIndex);  
