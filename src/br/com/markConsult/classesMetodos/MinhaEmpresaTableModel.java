 ...
 * @author jeferson
 */
public class MinhaEmpresaTableModel extends AbstractTableModel{
//constantes que vão representar as colunas
    ...
    private List<MinhaEmpresa> minhaEmpresas;
            
    
     public MinhaEmpresaTableModel() {
        minhaEmpresas = new ArrayList();
    }
     
      public MinhaEmpresaTableModel(List<MinhaEmpresa> lista) {
        this();
        minhaEmpresas.addAll(lista);
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        MinhaEmpresa c = minhaEmpresas.get(rowIndex);
    ...
    public boolean isCellEditable(int rowIndex, int columnIndex) {
     ...
     public void listar(List<MinhaEmpresa> c) {
        minhaEmpresas.clear();
        minhaEmpresas = c;
    ...
    public MinhaEmpresa getItem(int pos) {
        if (pos < 0 || pos >= minhaEmpresas.size()) {
            return null;
        }
 
        return minhaEmpresas.get(pos);
    }
}
