 ...
 * @author jeferson
 */
public class BuscaSetor extends javax.swing.JDialog {

    private boolean okselecionado = false;
    List<Setor> espcialidades;
    private final SetorTableModel model;
     ...
     * @param modal
     */
    public BuscaSetor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        jTSetors.setModel(model);

        CadSetorDAO dao = new CadSetorDAO();
        List<Setor> med = dao.buscaSetores("", 'e');
        model.listar(med);
        
        tf_dado.setDocument(new FixedLengthDocument(70));
        jTSetors.getColumnModel().getColumn(0).setMinWidth(15);
        jTSetors.getColumnModel().getColumn(1).setPreferredWidth(200);
        jTSetors.getSelectionModel().setSelectionInterval(0, 0);
        
        
        jTSetors.setAutoCreateRowSorter(true);
        
        TableRowSorter<SetorTableModel> sorter = new TableRowSorter<>((SetorTableModel) jTSetors.getModel());  
            jTSetors.setRowSorter(sorter);
        
        
        JTableHeader header = jTSetors.getTableHeader();  
    ...
    private void initComponents() {
        ...
        jTSetors = new javax.swing.JTable();
        ...
        jTSetors.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTSetors.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTSetorsMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTSetors);

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Busca Setores", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
    ...
    private void jTSetorsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTSetorsMouseClicked
    ...
    }//GEN-LAST:event_jTSetorsMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaSetor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BuscaSetor dialog = new BuscaSetor(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTSetors;
    private javax.swing.JTextField tf_dado;
    // End of variables declaration//GEN-END:variables

 

    public Setor retornEspSele() {
        int sele = jTSetors.getSelectedRow();

        Setor m = null;

        if (sele >= 0) {
            sele = jTSetors.convertRowIndexToModel(sele);
    ...
    public void pesquisa() {
        ...
        switch (cb_campo.getSelectedIndex()) {
            case 0:
                espcialidades = dao.buscaSetores(valor, 'e');
                break;
            case 1:
                espcialidades = dao.buscaSetores(valor, 'p');
                break;
