 ...
 * @author jeferson
 */
public class CadExame extends javax.swing.JInternalFrame {
int inserir_alterar = 0;
    /**
     * Creates new form CadExame
     */
    public CadExame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro de exame", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
    ...
    private void bt_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_salvarActionPerformed
        ...
        if (inserir_alterar == 0) {  
            ...
            Exame exame = new Exame(null, descricao, valor);

            int id = dao.inseExame(exame);
        ...
        if (inserir_alterar == 1) {
            ...
            CadExameDAO dao = new CadExameDAO();
            Exame exame = new Exame(id, descricao, valor);
            dao.altExame(exame);
    ...
    private void bt_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_excluirActionPerformed
        ...
        if (opcao_escolhida == JOptionPane.YES_OPTION) {
            ...
            CadExameDAO dao = new CadExameDAO();
            boolean excludo = dao.rmExame(id);
            if (excludo) {
                atualizaTela();
                estadoBotoes("inicial");
            }else{
...
if ("inicial".equals(botao)) {
 ...
 public void mostrar_dados(Exame exame) {
if(exame!=null){
        tf_codigo.setText(exame.getId().toString());
        tf_descri.setText(exame.getDescExame());
        tf_valor.setText(""+exame.getValor());
}
    }
...
public void buscaPorId(String id) {
    if (!id.equals("")) {
      ...
      CadExameDAO dao = new CadExameDAO();
        Exame exame = dao.buscEmpPid(Integer.parseInt(id));
        if(exame==null){
...
public void telBuscaExame(){
         BuscaExames tc = new BuscaExames(null, true);
        tc.setVisible(true);

        if (tc.okselecionado()) {
            Exame c = tc.retornEspSele();
            mostrar_dados(c);
        }
        tc.dispose();
}
