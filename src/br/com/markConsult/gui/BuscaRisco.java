 ...
 * @author jeferson
 */
public class BuscaRisco extends javax.swing.JDialog {

    private boolean okselecionado = false;
    List<Risco> espcialidades;
    private final RiscosTableModel model;
    ...
    public BuscaRisco(java.awt.Frame parent, boolean modal) {
        ...
        TableRowSorter<RiscosTableModel> sorter = new TableRowSorter<>((RiscosTableModel) jTRiscos.getModel());  
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Busca Risco", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaRisco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BuscaRisco dialog = new BuscaRisco(new javax.swing.JFrame(), true);
    ...
    public Risco retornEspSele() {
        int sele = jTRiscos.getSelectedRow();

        Risco m = null;

        if (sele >= 0) {
            sele = jTRiscos.convertRowIndexToModel(sele);
    ...
    public void pesquisa() {
        ...
        switch (cb_campo.getSelectedIndex()) {
            case 0:
                espcialidades = dao.buscaRisco(valor, 'e');
                break;
            case 1:
                espcialidades = dao.buscaRisco(valor, 'i');
                break;
        }
