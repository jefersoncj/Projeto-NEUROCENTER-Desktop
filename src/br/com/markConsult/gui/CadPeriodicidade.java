 ...
 * @author jeferson
 */
public class CadPeriodicidade extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Periodicidade");
        setToolTipText("");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/markConsult/imagens/help.png"))); // NOI18N

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro de Periodicidade", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
    ...
    private void bt_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_salvarActionPerformed
        ...
        if (inserir_alterar == 0) {
            ...
            Periodicidade periodicidade = new Periodicidade(null, fantasia);

            int id = dao.insePeriodicidade(periodicidade);
        ...
        if (inserir_alterar == 1) {
            ...
            CadPeriodicidadeDAO dao = new CadPeriodicidadeDAO();
            Periodicidade periodicidade = new Periodicidade(codigo, fantasia);
            dao.altPeriodicidade(periodicidade);
        }
        inserir_alterar = 0;
    ...
    private void bt_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_excluirActionPerformed
        ...
        if (opcao_escolhida == JOptionPane.YES_OPTION) {
            ...
            CadPeriodicidadeDAO dao = new CadPeriodicidadeDAO();
            boolean excludo = dao.rmPeriodicidade(id);
            if (excludo) {
                atualizaTela();
                estadoBotoes("inicial");
            } else {
                JOptionPane.showMessageDialog(null, "Periodicidade não pode ser excluído porque está sendo utilizado em outra tabela!");
            }
    ...
    private void bt_avançarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_avançarActionPerformed
        ...
        CadPeriodicidadeDAO dao = new CadPeriodicidadeDAO();
        Periodicidade c = dao.mostrarProximo(Integer.parseInt(tf_codigo.getText()));
        mostrar_dados(c);
    ...
    private void bt_primeiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_primeiroActionPerformed
        CadPeriodicidadeDAO dao = new CadPeriodicidadeDAO();
        Periodicidade c = dao.mostrarPrimeiro();
        mostrar_dados(c);
    ...
    private void bt_voltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_voltarActionPerformed
        ...
        CadPeriodicidadeDAO dao = new CadPeriodicidadeDAO();
        Periodicidade c = dao.mostrarAnterior(Integer.parseInt(tf_codigo.getText()));
        mostrar_dados(c);
...
// máscara do CNPJ: 99.999.999.9999-99
    ...
    private void atualizaTela() {
        CadPeriodicidadeDAO dao = new CadPeriodicidadeDAO();
        Periodicidade c = dao.mostrarUltimo();
        mostrar_dados(c);
    }

    public void mostrar_dados(Periodicidade emp) {
        SimpleDateFormat f = new SimpleDateFormat("dd/MM/yyyy");
        if (emp != null) {

         
                tf_codigo.setText("" + emp.getId());
                tf_fantasia.setText(emp.getDescPeriodicidade());
    ...
    public void buscaPeriodicidadePorId(String id) {
        CadPeriodicidadeDAO dao = new CadPeriodicidadeDAO();
        Periodicidade periodicidade = dao.buscEmpPid(Integer.parseInt(id));
        if (periodicidade == null) {
            JOptionPane.showMessageDialog(null, "Periodicidade não cadastrada!");
             tf_codigo.requestFocus();
        }
        mostrar_dados(periodicidade);
    }

    public void telBuscaPeriodicidade() {
        BuscaPeriodicidade pcp = new BuscaPeriodicidade(null, true);
        pcp.getRootPane().setWindowDecorationStyle(JRootPane.COLOR_CHOOSER_DIALOG);
        pcp.setVisible(true);

        if (pcp.okselecionado()) {

            Periodicidade emp = pcp.retornEspSele();
            mostrar_dados(emp);
        }
