 ...
 * @author jeferson
 */
public class BuscaClinica extends javax.swing.JDialog {

    private boolean okselecionado = false;
    List<Clinica> empresas;
     ...
     * @param modal
     */
    public BuscaClinica(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        List<Clinica> emp = dao.buscaEpresa("",'e');
        model.listar(emp);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaClinica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            BuscaClinica dialog = new BuscaClinica(new javax.swing.JFrame(), true);
