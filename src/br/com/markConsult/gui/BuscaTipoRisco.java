...
import br.com.markConsult.classesMetodos.TipoRiscoTableModel;
 ...
 * @author jeferson
 */
public class BuscaTipoRisco extends javax.swing.JDialog {

    private boolean okselecionado = false;
    List<TipoRisco> tipoRiscos;
    private final TipoRiscoTableModel model;
     ...
     * @param modal
     */
    public BuscaTipoRisco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        URL url = this.getClass().getResource("/br/com/markConsult/imagens/help.png");  
        Image imagemTitulo = Toolkit.getDefaultToolkit().getImage(url);  
        this.setIconImage(imagemTitulo); 
        model = new TipoRiscoTableModel();
        jTTipoRiscos.setModel(model);

        CadTipoRiscoDAO dao = new CadTipoRiscoDAO();
        List<TipoRisco> med = dao.buscaTipoRiscoes("", 'e');
        model.listar(med);
        
        tf_dado.setDocument(new FixedLengthDocument(70));
        jTTipoRiscos.getColumnModel().getColumn(0).setMinWidth(15);
        jTTipoRiscos.getColumnModel().getColumn(1).setPreferredWidth(200);
        jTTipoRiscos.getSelectionModel().setSelectionInterval(0, 0);
        
        
        jTTipoRiscos.setAutoCreateRowSorter(true);
        
        TableRowSorter<TipoRiscoTableModel> sorter = new TableRowSorter<>((TipoRiscoTableModel) jTTipoRiscos.getModel());  
            jTTipoRiscos.setRowSorter(sorter);
        
        
        JTableHeader header = jTTipoRiscos.getTableHeader();  
    ...
    private void initComponents() {
        ...
        jTTipoRiscos = new javax.swing.JTable();
        ...
        jTTipoRiscos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jTTipoRiscos.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTTipoRiscosMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTTipoRiscos);

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Busca  tipo de Risco", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
    ...
    private void jTTipoRiscosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTTipoRiscosMouseClicked
    ...
    }//GEN-LAST:event_jTTipoRiscosMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscaTipoRisco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BuscaTipoRisco dialog = new BuscaTipoRisco(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTTipoRiscos;
    private javax.swing.JTextField tf_dado;
    // End of variables declaration//GEN-END:variables

 

    public TipoRisco retornEspSele() {
        int sele = jTTipoRiscos.getSelectedRow();

        TipoRisco m = null;

        if (sele >= 0) {
            sele = jTTipoRiscos.convertRowIndexToModel(sele);
    ...
    public void pesquisa() {
        ...
        switch (cb_campo.getSelectedIndex()) {
            case 0:
                tipoRiscos = dao.buscaTipoRiscoes(valor, 'e');
                break;
            case 1:
                tipoRiscos = dao.buscaTipoRiscoes(valor, 'i');
                break;


        }

        model.listar(tipoRiscos);
