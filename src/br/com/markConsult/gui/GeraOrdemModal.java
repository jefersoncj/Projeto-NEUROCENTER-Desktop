 ...
 * @author Jeferson
 */
public class GeraOrdemModal extends javax.swing.JDialog {
String data = (new java.text.SimpleDateFormat("dd/MM/yyyy").format(new java.util.Date(System.currentTimeMillis())));
   
   
    private RiscosTableModel1 modelRiscos;
    private ExamesTableModel1 modelExames;
    /**
     * Creates new form GeraOrdemModal
     */
    public GeraOrdemModal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GeraOrdemModal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GeraOrdemModal dialog = new GeraOrdemModal(new javax.swing.JFrame(), true);
...
public final java.util.Date converte(String dataOrdem) throws ParseException {
    ...
    private void buscaDadosPaciente() {
    Paciente paciente = (Paciente) jC_paciente.getSelectedItem();
            ...
            //modelExames.listar(dao.buscExamePorFuncaoPeriod(emp,func));
            atualizajC_periodicade();    
    
    }
    
    public void mostraPaciente(String id){
        int idPaciente = Integer.parseInt(id);
        CadPacienteDAO dao = new CadPacienteDAO();
        Paciente p = dao.busaPacientePId(idPaciente);
