 ...
 * @author jeferson
 */
public class CadTipoRisco extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Tipo de Risco");
        setToolTipText("");
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/markConsult/imagens/help.png"))); // NOI18N

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro tipo de Risco", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP));
    ...
    private void bt_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_salvarActionPerformed
        ...
        if (inserir_alterar == 0) {
            ...
            TipoRisco tipoRisco = new TipoRisco(null, fantasia);

            int id = dao.inseTipoRisco(tipoRisco);
            tipoRisco.setId(id);
        ...
        if (inserir_alterar == 1) {
            ...
            CadTipoRiscoDAO dao = new CadTipoRiscoDAO();
            TipoRisco tipoRisco = new TipoRisco(codigo, fantasia);
            dao.altTipoRisco(tipoRisco);
        }
        inserir_alterar = 0;
    ...
    private void bt_excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_excluirActionPerformed
        ...
        if (opcao_escolhida == JOptionPane.YES_OPTION) {
            ...
            CadTipoRiscoDAO dao = new CadTipoRiscoDAO();
            boolean excludo = dao.rmTipoRisco(id);
            if (excludo) {
                atualizaTela();
                estadoBotoes("inicial");
            } else {
                JOptionPane.showMessageDialog(null, "TipoRisco não pode ser excluído porque está sendo utilizado em outra tabela!");
            }
    ...
    private void bt_avançarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_avançarActionPerformed
        ...
        CadTipoRiscoDAO dao = new CadTipoRiscoDAO();
        TipoRisco c = dao.mostrarProximo(Integer.parseInt(tf_codigo.getText()));
        mostrar_dados(c);
    ...
    private void bt_primeiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_primeiroActionPerformed
        CadTipoRiscoDAO dao = new CadTipoRiscoDAO();
        TipoRisco c = dao.mostrarPrimeiro();
        mostrar_dados(c);
    ...
    private void bt_voltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_voltarActionPerformed
        ...
        CadTipoRiscoDAO dao = new CadTipoRiscoDAO();
        TipoRisco c = dao.mostrarAnterior(Integer.parseInt(tf_codigo.getText()));
        mostrar_dados(c);
...
// máscara do CNPJ: 99.999.999.9999-99
    ...
    private void atualizaTela() {
        CadTipoRiscoDAO dao = new CadTipoRiscoDAO();
        TipoRisco c = dao.mostrarUltimo();
        mostrar_dados(c);
    }

    public void mostrar_dados(TipoRisco emp) {
        SimpleDateFormat f = new SimpleDateFormat("dd/MM/yyyy");
        if (emp != null) {

         
                tf_codigo.setText("" + emp.getId());
                tf_fantasia.setText(emp.getDescTipoRisco());
    ...
    public void buscaTipoRiscoPorId(String id) {
        CadTipoRiscoDAO dao = new CadTipoRiscoDAO();
        TipoRisco tipoRisco = dao.buscEmpPid(Integer.parseInt(id));
        if (tipoRisco == null) {
            JOptionPane.showMessageDialog(null, "TipoRisco não cadastrada!");
             tf_codigo.requestFocus();
        }
        mostrar_dados(tipoRisco);
    }

    public void telBuscaTipoRisco() {
        ...
        if (pcp.okselecionado()) {
            ...
            TipoRisco emp = pcp.retornEspSele();
            mostrar_dados(emp);
        }
